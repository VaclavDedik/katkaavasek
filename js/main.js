...
const i18n = {
  cs: {
    ...
    giftsText1:  'Nemusíte pátrat po ideálním kávovaru, sadě hrnců ani porcelánovém jelenovi.',
    giftsText2:  'Největší radost nám udělá, když náš svatební den oslavíte společně s námi. Pokud byste nás přesto chtěli potěšit i něčím navíc, budeme vděční za finanční dar, který využijeme na svatební cestu a společné zážitky.',
    giftsText3:  'Dary samozřejmě nejsou povinné a jejich případná výše záleží jen na vás.',
    rsvpTitle:   'RSVP',
    rsvpBtn:     'RSVP',
    rsvpName:    'Jméno',
    rsvpEmail:   'E-mail',
  ...
  en: {
    ...
    giftsText1:  'There is no need to search for the perfect coffee machine, a set of pots, or a porcelain deer.',
    giftsText2:  'What would make us happiest is having you celebrate our wedding day with us. If you would still like to give us something extra, we would be grateful for a financial gift, which we will put towards our honeymoon and shared experiences.',
    giftsText3:  'Gifts are, of course, not mandatory, and the amount is entirely up to you.',
    rsvpTitle:   'RSVP',
    rsvpBtn:     'RSVP',
    rsvpName:    'Name',
    rsvpEmail:   'Email',
